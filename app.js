...
let sortedByBirthYear = inventors.sort ((inventorA, inventorB) => inventorA.year-inventorB.year)
...
let inventorNamedAda = inventors.find ((inventor, i) => {
    if (inventor.first === 'Ada') return inventor
})
...
let idx = comments.findIndex ((comment, i) => {
